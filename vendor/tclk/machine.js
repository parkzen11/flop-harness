...
import { contractId, isValidStatement, validateFrame, } from "./frames.js";
import { verifySecret } from "./locks.js";
import { normalizeRailId } from "./rails.js";
export const TCLK_TERMINAL_STATUSES = new Set([
    "claimed",
    "refunded",
    "cancelled",
]);
...
function tclk1OfferIncludesRail(offered, selected) {
